...
void CreateStartCanvas() {
  ...
  main_canvas.AddUIElement(new Button(cv::Point(1280 / 2 - 100, 720 / 2 - 30 - 50), cv::Size(200, 50), []() {CreateRegistrationCanvas();}, CV_RGB(0, 0, 0), "Start registration"));
...
void CreateRegistrationSuccesCanvas(
	//std::vector<cv::Mat> images = nullptr
) {
  main_canvas.ClearCanvas();
